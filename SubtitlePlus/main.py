...
def callback():
    ...
    return flask.render_template("tweeted.html")
# Above for tweet
###################################################
...
@app.route('/tweet_done', methods=['GET','POST'])
def tweet_done():
    global payload
    content = flask.request.form['descr']
...
def twitter():
    """Send a tweet"""
    return flask.render_template("upload_twitter.html")
